              ...
              <form action="">
                <div className="flex flex-col gap-2">
                  <div className=" flex flex-row justify-center md ">
                    <input type="text" name="" placeholder="YOUR NAME" className="bg-[#F7F7F8] w-full rounded md:p-1 placeholder:text-left outline-none text-gray-200" />
                  </div>
                  <div className=" flex flex-row justify-center md ">
                    <input type="email" name="" placeholder="YOUR EMAIL" className="bg-[#F7F7F8] w-full rounded md:p-1 placeholder:text-left outline-none text-gray-200 " />
                  </div>
                 
                  <div className="">
                    <textarea name="" id="" cols="50" rows="10" placeholder="Message here..." className="bg-[#F7F7F8] rounded-md w-full outline-none text-gray-200 p-1 "></textarea>
                  </div>
