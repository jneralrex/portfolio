...
import { Link } from 'react-router-dom'; // Crucial for standalone file execution
import { ThemeToggle } from './ThemeToggle';

const Navbar = () => {
  return (
    <header className="fixed top-0 left-0 w-full bg-[#F9F9FB]/60 dark:bg-[#0B0C10]/60 backdrop-blur-xl border-b border-zinc-200/60 dark:border-zinc-800/50 py-4 px-6 md:px-12 flex justify-between items-center z-50">
