...
const Projects = () => {
  ...
  return (
    <div className="bg-[#0B0C10] text-[#F4F4F6] min-h-screen selection:bg-zinc-700 selection:text-white font-sans antialiased overflow-x-hidden relative py-24 px-6 md:px-12 xl:px-24">
     
      <div className="max-w-3xl mx-auto mb-24 relative z-10 border border-zinc-800/80 bg-zinc-900/20 backdrop-blur-md rounded-xl p-6 flex flex-col sm:flex-row gap-4 items-center sm:items-start text-center sm:text-left">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#1f2025_1px,transparent_1px),linear-gradient(to_bottom,#1f2025_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6 mb-16 relative z-10">
        <div className="flex items-center gap-6">
          ...
          <div>
            <span className="text-orange-600 dark:text-orange-500 text-xs  tracking-widest block mb-1"> —System Architectures  </span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white">Project Catalog</h2>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex justify-between items-start px-1">
              <div className="max-w-[80%]">
                <h3 className="text-lg font-semibold text-white tracking-tight group-hover:text-zinc-300 transition-colors truncate">
                  {project.title}
                </h3>
              </div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs font-mono font-medium text-zinc-400 group-hover:text-white transition-colors border-b border-transparent hover:border-white pb-0.5"
              >
